let crl = document.querySelector('canvas#myCrl').getContext('2d');
...
let crl1 = document.querySelector('canvas#myCrl1').getContext('2d');
...
let crl2 = document.querySelector('canvas#myCrl2').getContext('2d');
